...
data.settings.map = [
  //编号，名称，通往个数，编号，怪物个数(max 4)，怪物编号，人物个数，编号(无则0)
  [0, "村庄", 2, [1, 2], 1, [0], 3, [0, 1, 2]],
  [1, "树林1", 2, [0, 3], 2, [0, 1], 0, 0],
  [2, "草丛1", 2, [0, 4], 3, [0, 1, 2], 0, 0],
  [3, "树林2", 2, [1, 5], 2, [2, 4], 0, 0],
  [4, "草丛2", 2, [2, 6], 3, [2, 3, 4], 0, 0],
  [5, "森林1", 3, [6, 3, 7], 4, [3, 5, 4, 6], 0, 0],
